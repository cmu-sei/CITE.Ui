...
export class TeamUserService {
     ...
     * Returns a list of the specified evaluation&#39;s TeamUsers.  &lt;para /&gt;  Only accessible to an evaluation user
     * @param evaluationId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getEvaluationTeamUsers(evaluationId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<TeamUser>>;
    public getEvaluationTeamUsers(evaluationId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TeamUser>>>;
    public getEvaluationTeamUsers(evaluationId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TeamUser>>>;
    public getEvaluationTeamUsers(evaluationId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (evaluationId === null || evaluationId === undefined) {
            throw new Error('Required parameter evaluationId was null or undefined when calling getEvaluationTeamUsers.');
        }
        ...
        return this.httpClient.get<Array<TeamUser>>(`${this.configuration.basePath}/api/evaluations/${encodeURIComponent(String(evaluationId))}/teamusers`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * Returns a list of the specified team&#39;s TeamUsers.  &lt;para /&gt;  Only accessible to an evaluation user
     * @param teamId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
