...
export class TeamService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMyEvaluationTeams(evaluationId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Team>>;
    public getMyEvaluationTeams(evaluationId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Team>>>;
    public getMyEvaluationTeams(evaluationId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Team>>>;
    public getMyEvaluationTeams(evaluationId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Team>>(`${this.configuration.basePath}/api/evaluations/${encodeURIComponent(String(evaluationId))}/myteams`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
