...
export class SubmissionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public changeSubmissionComment(submissionId: string, submissionCommentId: string, SubmissionComment?: SubmissionComment, observe?: 'body', reportProgress?: boolean): Observable<Submission>;
    public changeSubmissionComment(submissionId: string, submissionCommentId: string, SubmissionComment?: SubmissionComment, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Submission>>;
    public changeSubmissionComment(submissionId: string, submissionCommentId: string, SubmissionComment?: SubmissionComment, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Submission>>;
    public changeSubmissionComment(submissionId: string, submissionCommentId: string, SubmissionComment?: SubmissionComment, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (submissionId === null || submissionId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeSubmissionComment(submissionId: string, submissionCommentId: string, observe?: 'body', reportProgress?: boolean): Observable<Submission>;
    public removeSubmissionComment(submissionId: string, submissionCommentId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Submission>>;
    public removeSubmissionComment(submissionId: string, submissionCommentId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Submission>>;
